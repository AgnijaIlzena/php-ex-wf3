...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1555132766ltr&server=1">
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"2136524837536a7746392b445e595f5d",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"36000",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"cookie",user:"root"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=posts">`blog`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=categories">`blog`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=users">`blog`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=entrainement&table=etudiants">`entrainement`.`etudiants`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=entrainement&table=article">`entrainement`.`article`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=entrainement&table=client">`entrainement`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=recettes&table=ingredients">`recettes`.`ingredients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=recettes&table=recettes">`recettes`.`recettes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=recettes&table=utilisateurs">`recettes`.`utilisateurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=recettes&table=recettes_ingredients">`recettes`.`recettes_ingredients`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2136524837536a7746392b445e595f5d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="blog" targettable="categories">
            ...
            Queried time
                            ...
                            <span class="query">SELECT categories.name AS categoryname, categories.id AS categoryId FROM categories;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="categories">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `categories`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="posts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `posts`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `posts` WHERE `posts`.`id` = 16</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="posts">
                            <div class="action_content">
